...
2. Clone the repo
   ```sh
   git clone https://github.com/koskasmail/webplayground.git
   ```
...
See the [open issues](https://github.com/koskasmail/webplayground/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/koskasmail/webplayground](https://github.com/koskasmail/webplayground)
